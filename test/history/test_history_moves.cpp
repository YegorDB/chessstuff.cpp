...
void testHistoryMovesAddMainLineMove() {
    ...
    historyMoves.addMainLineMove(
        HistoryMove{ Piece::Type::PAWN, sp("e2"), sp("e4"), HistoryMove::Type::PLACE, 0, false, Piece::Type::UNSET, PointSet{} }
    );
    assert_strings_are_equal(historyMoves.toString(), "1.e4");

    historyMoves.addMainLineMove(
        HistoryMove{ Piece::Type::PAWN, sp("e7"), sp("e5"), HistoryMove::Type::PLACE, 0, false, Piece::Type::UNSET, PointSet{} }
    );
    assert_strings_are_equal(historyMoves.toString(), "1.e4 e5");

    historyMoves.addMainLineMove(
        HistoryMove{ Piece::Type::KNIGHT, sp("g1"), sp("f3"), HistoryMove::Type::PLACE, 0, false, Piece::Type::UNSET, PointSet{} }
    );
...
void testHistoryMovesAddSideLineMove() {
    ...
    historyMoves.addSideLineMove(
        HistoryMove{ Piece::Type::PAWN, sp("c7"), sp("c5"), HistoryMove::Type::PLACE, 0, false, Piece::Type::UNSET, PointSet{} },
    ...
    historyMoves.addSideLineMove(
        HistoryMove{ Piece::Type::PAWN, sp("d2"), sp("d4"), HistoryMove::Type::PLACE, 0, false, Piece::Type::UNSET, PointSet{} },
        historyMoves.getItems().size() - 1
    );
    ...
    historyMoves.addSideLineMove(
        HistoryMove{ Piece::Type::BISHOP, sp("f1"), sp("c4"), HistoryMove::Type::PLACE, 0, false, Piece::Type::UNSET, PointSet{} },
