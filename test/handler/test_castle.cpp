...
void testCastleMove() {
    ...
    assert_point_sets_are_equal(actions1.get(Action::Type::PLACE).get(Action::Relation::TO), (PointSet{sp("c1"), sp("d1"), sp("d2"), sp("e2"), sp("f2"), sp("f1"), sp("g1")}));
    ...
    assert_point_sets_are_equal(actions2.get(Action::Type::PLACE).get(Action::Relation::TO), (PointSet{sp("c8"), sp("d8"), sp("d7"), sp("e7"), sp("f7"), sp("f8"), sp("g8")}));
...
void testRestrictCastleMove() {
    ...
    Actions actions1 = handler1.getActionsPlaces().getActions(sp("e1"));
    assert_point_sets_are_equal(actions1.get(Action::Type::PLACE).get(Action::Relation::TO), (PointSet{sp("d1"), sp("d2"), sp("f2"), sp("f1")}));

    Handler handler2{FEN{"r3k2r/8/8/8/8/8/4b3/R3K2R w KQkq - 0 1"}};
    Actions actions2 = handler2.getActionsPlaces().getActions(sp("e1"));
    assert_point_sets_are_equal(actions2.get(Action::Type::PLACE).get(Action::Relation::TO), (PointSet{sp("d2"), sp("f2")}));

    Handler handler3{FEN{"r3k2r/8/8/8/8/4b3/8/R3K2R w KQkq - 0 1"}};
    Actions actions3 = handler3.getActionsPlaces().getActions(sp("e1"));
    assert_point_sets_are_equal(actions3.get(Action::Type::PLACE).get(Action::Relation::TO), (PointSet{sp("d1"), sp("e2"), sp("f1")}));

    Handler handler4{FEN{"r3k2r/8/8/8/4b3/8/8/R3K2R w KQkq - 0 1"}};
    Actions actions4 = handler4.getActionsPlaces().getActions(sp("e1"));
    assert_point_sets_are_equal(actions4.get(Action::Type::PLACE).get(Action::Relation::TO), (PointSet{sp("c1"), sp("d1"), sp("d2"), sp("e2"), sp("f2"), sp("f1"), sp("g1")}));

    Handler handler5{FEN{"r3k2r/8/8/8/8/8/4Q3/R3K2R b KQkq - 0 1"}};
    Actions actions5 = handler5.getActionsPlaces().getActions(sp("e8"));
    assert_point_sets_are_equal(actions5.get(Action::Type::PLACE).get(Action::Relation::TO), (PointSet{sp("d8"), sp("d7"), sp("f7"), sp("f8")}));

    Handler handler6{FEN{"r3k2r/4B3/8/8/8/8/8/R3K2R b KQkq - 0 1"}};
    Actions actions6 = handler6.getActionsPlaces().getActions(sp("e8"));
    assert_point_sets_are_equal(actions6.get(Action::Type::PLACE).get(Action::Relation::TO), (PointSet{sp("d7"), sp("f7")}));

    Handler handler7{FEN{"r3k2r/8/4B3/8/8/8/8/R3K2R b KQkq - 0 1"}};
    Actions actions7 = handler7.getActionsPlaces().getActions(sp("e8"));
    assert_point_sets_are_equal(actions7.get(Action::Type::PLACE).get(Action::Relation::TO), (PointSet{sp("d8"), sp("e7"), sp("f8")}));

    Handler handler8{FEN{"r3k2r/8/8/4B3/8/8/8/R3K2R b KQkq - 0 1"}};
    Actions actions8 = handler8.getActionsPlaces().getActions(sp("e8"));
    assert_point_sets_are_equal(actions8.get(Action::Type::PLACE).get(Action::Relation::TO), (PointSet{sp("c8"), sp("d8"), sp("d7"), sp("e7"), sp("f7"), sp("f8"), sp("g8")}));
}
