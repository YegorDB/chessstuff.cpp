...
void testCheckIsCheckmate() {
    Handler handler1{FEN{"3k2R1/8/3K4/8/8/8/8/8 b - - 0 1"}};
    assert(handler1.getState().result.type == State::Result::Type::CHECKMATE);
    assert(handler1.getState().result.winnerColor == Piece::Color::WHITE);
    ...
    Handler handler8{FEN{"8/8/8/8/4r3/2k5/3b1N2/3QK3 w - - 0 1"}};
    assert(handler8.getState().result.type == State::Result::Type::UNSET);
    assert(handler8.getState().result.winnerColor == Piece::Color::UNSET);
    assert(handler8.getState().result.drawType == State::Result::DrawType::UNSET);

    Handler handler9{FEN{"8/8/8/8/4r3/2k5/3b1N2/3QKn2 w - - 0 1"}};
    assert(handler9.getState().result.type == State::Result::Type::UNSET);
    assert(handler9.getState().result.winnerColor == Piece::Color::UNSET);
    assert(handler9.getState().result.drawType == State::Result::DrawType::UNSET);

    Handler handler10{FEN{"3k4/8/3K2R1/8/8/8/8/8 w - - 0 1"}};
    ...
    assert(handler10.getState().result.winnerColor == Piece::Color::WHITE);
    assert(handler10.getState().result.drawType == State::Result::DrawType::UNSET);

    Handler handler11{FEN{"8/8/8/1b6/4r3/2k1b3/5N2/3QK3 b - - 0 1"}};
    ...
    assert(handler11.getState().result.winnerColor == Piece::Color::BLACK);
    assert(handler11.getState().result.drawType == State::Result::DrawType::UNSET);
}

void testCheckIsStalemate() {
    Handler handler{FEN{"8/8/8/8/p7/Pp6/1P6/K1k5 w - - 0 1"}};
    assert(handler.getState().result.type == State::Result::Type::DRAW);
    assert(handler.getState().result.winnerColor == Piece::Color::UNSET);
...
void testCheckIsInsufficientMaterial() {
    ...
    assert(handler1.getState().result.winnerColor == Piece::Color::UNSET);
    ...
    assert(handler7.getState().result.winnerColor == Piece::Color::UNSET);
    assert(handler7.getState().result.drawType == State::Result::DrawType::UNSET);
